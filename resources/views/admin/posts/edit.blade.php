                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" rows="5"
                                    ...
                                    id="exampleInputCat2" placeholder="Введите описание Статьи"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input value="{{ $post->description }}" type="file" name="thumbnail" class="custom-file-input" id="exampleInputFile">
